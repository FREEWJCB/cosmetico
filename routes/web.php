...
Route::resource('Tipo', TipoController::class)->except('show','edit','create');
...
Route::resource('Marca', MarcaController::class)->except('show','edit','create');
...
Route::resource('Modelo', ModeloController::class)->except('show','edit','create');
...
Route::resource('Cosmetic', CosmeticController::class)->except('show','edit','create');
...
Route::resource('Cosmetico', CosmeticoController::class)->except('show','edit','create');
...
Route::resource('Curso', CursoController::class)->except('show','edit','create');
