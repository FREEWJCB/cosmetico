...
Route::resource('Tipo', 'TipoController')->except('show','edit','create');
...
Route::resource('Marca', 'MarcaController')->except('show','edit','create');
...
Route::resource('Modelo', 'ModeloController')->except('show','edit','create');
...
Route::resource('Cosmetic', 'CosmeticController')->except('show','edit','create');
...
Route::resource('Cosmetico', 'CosmeticoController')->except('show','edit','create');
...
Route::resource('Ocupacion_Laboral', 'Ocupacion_LaboralController')->except('show','edit','create');
...
Route::resource('Tipo_Usuario', 'Tipo_UsuarioController')->except('show','edit','create');
...
Route::resource('Tipo_Alergia', 'Tipo_AlergiaController')->except('show','edit','create');
...
Route::resource('Tipo_Discapacidad', 'Tipo_DiscapacidadController')->except('show','edit','create');
...
Route::resource('Alergia', 'AlergiaController')->except('show','edit','create');
...
Route::resource('Discapacidad', 'DiscapacidadController')->except('show','edit','create');
...
Route::resource('Cargo', 'CargoController')->except('show','edit','create');
...
Route::resource('Seccion', 'SeccionController')->except('show','edit','create');
...
Route::resource('Salon', 'SalonController')->except('show','edit','create');
...
Route::resource('Grado', 'GradoController')->except('show','edit','create');
...
Route::resource('State', 'StateController')->except('show','edit','create');
...
Route::resource('Municipality', 'MunicipalityController')->except('show','edit','create');
